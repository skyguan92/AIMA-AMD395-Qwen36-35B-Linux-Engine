...
described below require v1.5.1-native-vl.10 or a build containing the tool-media
change; v1.5.1-native-vl.9 accepts media in user messages only. Other surfaces
