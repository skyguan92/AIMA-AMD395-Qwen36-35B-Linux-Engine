...
v1.5.1-native-vl.2 在可搬移原生包内补齐固定模型的图片、视频、混合媒体和多轮
...
> v1.5.1-native-vl.2 在 ready 前完成全部视觉权重与两个视觉 attention 路径的
...
先从[个人上游 v1.5.1-native-vl.2 Release](https://github.com/skyguan92/AIMA-AMD395-Qwen36-35B-Linux-Engine/releases/tag/v1.5.1-native-vl.2)
下载运行包与校验文件：
...
已发布的 v1.5.1-native-vl.2 CLI 提供：
...
完整精度、每次测量值和组件哈希见
`benchmarks/results/native-vl-g5-release-v1.5.1-native-vl.2.json`，package-input
