...
def build_matrix(
    ...
    *,
    ...
    cells = [
        ...
        cell("video_sampling_max_q32k_output1", ["video_sampling_maximum"], [], ["video_sampling_max"], "32k", 19_404, 1, {"video": ["sampling_maximum"], "context": ["32k"], "output": ["1"], "cache": ["disabled"]}, media_io_kwargs={"video": {"num_frames": 768, "video_backend": "opencv"}}),
        cell("video_sampling_clamp_q32k_output1", ["video_sampling_maximum"], [], ["video_sampling_above"], "32k", 19_348, 1, {"video": ["sampling_above_maximum_clamp"], "context": ["32k"], "output": ["1"], "cache": ["disabled"]}, media_io_kwargs={"video": {"num_frames": 768, "video_backend": "opencv"}}),
