...
PREFILL_REGISTRY_CPP="${OUT_DIR}/vl-layer3-composed-prefill-registry.cpp"
FROZEN_TEXT_PREFILL_REGISTRY_CPP="${OUT_DIR}/vl-layer3-composed-frozen-text-prefill-registry.cpp"
...
python3 "${ROOT}/scripts/generate-native-aot-registry.py" \
  ...
  --manifest "${UNIFIED_ATTENTION_DECODE_DIR}/manifest.json" \
