...
def configure_release(release: str, recorded_on: str) -> None:
    ...
    if release == "1.5.1-native-vl.5":
        return
    if release not in ("1.5.1-native-vl.6", "1.5.1-native-vl.7", "1.5.1-native-vl.8", "1.5.1-native-vl.9"):
...
def main() -> int:
    ...
    parser.add_argument("--release", choices=("1.5.1-native-vl.5", "1.5.1-native-vl.6", "1.5.1-native-vl.7", "1.5.1-native-vl.8", "1.5.1-native-vl.9"), default=RELEASE)
