...
Json request_metrics_json(const NativeResidentRequestMetrics& metrics) {
  Json result = {{"runtime", "native-resident-q" +
          ...
          {"vl", {{"enabled", metrics.vl_enabled},
                  ...
                  {"vision_attention_image_sha256s",
                   metrics.vl_vision_attention_image_sha256s},
          ...
          {"prefix_cache", {{"implemented", true},
                            {"scope", "capacity-bounded-safe-message-prefix-lru"},
                            ...
                            {"restore_bytes",
                             metrics.prefix_cache_restore_bytes},
                            {"active_kv_reused",
...
int run_native_http_server(int argc, char** argv) {
  ...
  std::cout << Json({{"event", "ready"},
                     ...
                     {"vision_attention_image_sha256",
                      load.vision_attention_image_sha256},
                     {"vision_dense_image_attention_image_sha256",
                      load.vision_dense_image_attention_image_sha256},
                     ...
                     {"vision_image_count_warmup_patches",
                      load.vision_image_count_warmup_patches},
                     {"vision_image_count_warmup_visual_tokens",
                      load.vision_image_count_warmup_visual_tokens},
                     ...
                     {"vision_image_count_warmup_plan_build_wall_ms",
                      load.vision_image_count_warmup_plan_build_wall_ms},
                     {"vision_image_count_warmup_encode_wall_ms",
                      load.vision_image_count_warmup_encode_wall_ms},
