.PHONY: check check-cpu check-native-syntax check-python-package security-scan verify-evidence test verify native-layout-check native-chat-template-parity build-native build-direct-loader build-native-visual-weight-probe build-native-vl-embedding-probe build-native-vl-mrope-probe build-native-vl-language-layer0-probe build-native-vl-language-layer3-composed-probe build-native-vision-patch-probe build-native-vision-position-probe build-native-vision-aot-attention-probe build-native-vision-aot-block-stack-probe build-native-vision-exact-layer-norm-probe build-native-vision-merger-probe build-native-vision-pipeline-probe build-native-vision-block-prefix-probe build-native-vision-block-suffix-probe build-native-vision-block-probe build-native-vision-block-stack-probe build-native-vision-depth-block-probe build-native-vision-rotary-probe build-native-vision-segmented-attention-probe build-native-runtime package-native package-native-foundation package-evidence
...
check-cpu:
	...
	python3 -m py_compile scripts/capture-native-lm-head-reference.py scripts/capture-native-visual-layout.py scripts/capture-vl-reference-manifest.py scripts/capture-vllm-vision-block-oracles.py scripts/capture-vllm-vision-depth-oracles.py scripts/capture-vllm-vision-multimedia-block-oracles.py scripts/capture-vllm-vision-position-oracles.py scripts/capture-vllm-vl-api-render.py scripts/capture-vllm-vl-language-layer0-diagnostics.py scripts/capture-vllm-vl-language-layer3-mrope-diagnostics.py scripts/capture-vllm-vl-language-prefix-diagnostics.py scripts/capture-vllm-vl-oracles.py scripts/check-native-wvsplitk-parity.py scripts/check-public-tree.py scripts/export-native-aot-closure.py scripts/generate-native-aot-registry.py scripts/generate-native-decode-registry.py scripts/generate-native-decode-schedule.py scripts/generate-native-product-result.py scripts/generate-native-visual-layout.py scripts/generate-vl-capability-envelope.py scripts/generate-vl-capability-fixtures.py scripts/generate-vl-reference-launch.py scripts/native_bundle_closure.py scripts/package-release-evidence.py scripts/probe-vllm-vl-api-capabilities.py scripts/probe-vl-processor-capabilities.py scripts/qualify-native-correctness.py scripts/qualify-native-eval.py scripts/qualify-native-full-matrix.py scripts/qualify-native-openai-features.py scripts/qualify-native-portable-bundle.py scripts/qualify-native-surfaces.py scripts/qualify-native-vl-capabilities.py scripts/trace-vllm-vision-attention-aot.py scripts/verify-native-package-inputs.py scripts/verify-release-evidence.py scripts/native_aot_trace/sitecustomize.py
