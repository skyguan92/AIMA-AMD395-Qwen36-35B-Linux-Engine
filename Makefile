...
check-cpu: check-native-http-support
	...
	python3 -m py_compile scripts/generate-native-bundle-manifest.py scripts/generate-native-vl-g5-qualification.py scripts/generate-native-vl-patch-g5-qualification.py scripts/generate-native-vl-patch-product-qualification.py scripts/generate-native-vl-product-qualification.py scripts/generate-native-vl-release-provenance.py scripts/qualify-native-chat-protocol.py scripts/qualify-native-http-control-plane.py scripts/qualify-native-temperature-sampling.py scripts/qualify-native-vl-release-gates.py scripts/qualify-native-vl-resident-soak.py scripts/qualify-native-vl-rollback.py
