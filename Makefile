...
check-cpu:
	...
	python3 -m py_compile scripts/aima_vllm_vl_performance_server.py scripts/capture-vl-performance-request.py scripts/generate-native-vl-g3-qualification.py scripts/generate-vl-performance-matrix.py scripts/summarize-vl-performance-diagnostic.py scripts/summarize-vl-performance-matrix-pair.py scripts/summarize-vl-performance-matrix.py scripts/summarize-vl-performance-pairs.py scripts/vllm_vl_benchmark_middleware.py
