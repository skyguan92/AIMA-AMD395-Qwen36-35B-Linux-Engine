.PHONY: check check-cpu check-native-syntax test verify native-layout-check native-chat-template-parity build-native build-direct-loader build-native-runtime package-native package-native-foundation
