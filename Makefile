.PHONY: check check-cpu check-native-syntax check-python-package security-scan verify-evidence test verify native-layout-check native-chat-template-parity build-native build-direct-loader build-native-visual-weight-probe build-native-vision-patch-probe build-native-vision-position-probe build-native-vision-block-prefix-probe build-native-vision-block-suffix-probe build-native-vision-block-probe build-native-vision-block-stack-probe build-native-vision-depth-block-probe build-native-vision-rotary-probe build-native-vision-segmented-attention-probe build-native-runtime package-native package-native-foundation package-evidence
