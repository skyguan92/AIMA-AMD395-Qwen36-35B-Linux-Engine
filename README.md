...
Version 1.5.1-native-vl.9 includes the complete fixed-model image, video, mixed-media
...
[upstream v1.5.1-native-vl.9 release](https://github.com/skyguan92/AIMA-AMD395-Qwen36-35B-Linux-Engine/releases/tag/v1.5.1-native-vl.9),
...
The v1.5.1-native-vl.9 CLI provides:
...
[patch product contract](native/product-contract-v1.5.1-native-vl.9.json) and
