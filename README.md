...
[![Release](https://img.shields.io/badge/release-v1.5.1--native--vl.2-green.svg)](https://github.com/skyguan92/AIMA-AMD395-Qwen36-35B-Linux-Engine/releases/tag/v1.5.1-native-vl.2)
...
Version 1.5.1-native-vl.2 adds the complete fixed-model image, video, mixed-media
...
> recurrent state at the logical prompt boundary. v1.5.1-native-vl.2 loads and
...
[native/product-contract-v1.5.1-native-vl.2.json](native/product-contract-v1.5.1-native-vl.2.json).
...
[upstream v1.5.1-native-vl.2 release](https://github.com/skyguan92/AIMA-AMD395-Qwen36-35B-Linux-Engine/releases/tag/v1.5.1-native-vl.2),
...
The published v1.5.1-native-vl.2 CLI provides:
...
`benchmarks/results/native-vl-g5-release-v1.5.1-native-vl.2.json`; its package
