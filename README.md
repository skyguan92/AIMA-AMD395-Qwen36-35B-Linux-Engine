...
Version 1.5.1-native-vl.8 includes the complete fixed-model image, video, mixed-media
...
> v1.5.1-native-vl.8 permits verification retries after completed repairs and
...
[upstream v1.5.1-native-vl.8 release](https://github.com/skyguan92/AIMA-AMD395-Qwen36-35B-Linux-Engine/releases/tag/v1.5.1-native-vl.8),
...
The v1.5.1-native-vl.8 CLI provides:
...
[patch product contract](native/product-contract-v1.5.1-native-vl.8.json) and
the hash-bound release evidence mirrored after publication. Its package-input
qualification is embedded as `share/aima/qualification.json`. The `.8`
...
fail-closed runtime-diff rule; it is not described as an exact `.8` host run.
