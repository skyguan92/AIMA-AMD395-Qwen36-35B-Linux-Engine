...
[![Release](https://img.shields.io/badge/release-v1.5.1--native--vl.7-green.svg)](https://github.com/skyguan92/AIMA-AMD395-Qwen36-35B-Linux-Engine/releases/tag/v1.5.1-native-vl.7)
...
Version 1.5.1-native-vl.7 includes the complete fixed-model image, video, mixed-media
...
[native/product-contract-v1.5.1-native-vl.7.json](native/product-contract-v1.5.1-native-vl.7.json).
...
[upstream v1.5.1-native-vl.7 release](https://github.com/skyguan92/AIMA-AMD395-Qwen36-35B-Linux-Engine/releases/tag/v1.5.1-native-vl.7),
...
The v1.5.1-native-vl.7 CLI provides:
...
[patch product contract](native/product-contract-v1.5.1-native-vl.7.json) and
the hash-bound release evidence mirrored after publication. Its package-input
qualification is embedded as `share/aima/qualification.json`. The `.7`
...
fail-closed runtime-diff rule; it is not described as an exact `.7` host run.
